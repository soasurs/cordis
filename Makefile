...
INTERNAL_PROTO_DIRS := proto/authenticator proto/user proto/message proto/guild proto/presence proto/gateway
...
test-integration:
	...
	go test -tags=integration ./services/user/v1/internal/store ./services/authenticator/v1/internal/store ./services/message/v1/internal/store ./services/guild/v1/internal/store
