...
func TestLoadConfig(t *testing.T) {
	...
	require.Equal(t, 5, cfg.Dispatcher.DispatchTimeoutSeconds)
	require.Equal(t, 10, cfg.Dispatcher.RevokeTimeoutSeconds)
	...
	require.Equal(t, 128, cfg.Dispatcher.MaxUncommittedRecords)
