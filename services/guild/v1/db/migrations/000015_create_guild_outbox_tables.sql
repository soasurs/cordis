CREATE TABLE IF NOT EXISTS guild_event_streams (
    stream_key     TEXT PRIMARY KEY,
    relay_shard_id INT NOT NULL CHECK (relay_shard_id >= 0),
    last_sequence  BIGINT NOT NULL DEFAULT 0 CHECK (last_sequence >= 0)
);

CREATE TABLE IF NOT EXISTS guild_outbox_events (
...
CREATE INDEX IF NOT EXISTS idx_guild_outbox_fetch
    ON guild_outbox_events (relay_shard_id, stream_key, stream_sequence);
