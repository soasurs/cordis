...
const file_api_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x13api/v1/common.proto\x12\x06api.v1\x1a\x11api/v1/user.proto\"\xe6\x01\n" +
	"\x05Guild\x12\x0e\n" +
	...
	"&GUILD_PERMISSION_OVERWRITE_TYPE_MEMBER\x10\x02B~\n" +
	"\n" +
	"com.api.v1B\vCommonProtoP\x01Z*github.com/soasurs/cordis/gen/api/v1;apiv1\xa2\x02\x03AXX\xaa\x02\x06Api.V1\xca\x02\x06Api\\V1\xe2\x02\x12Api\\V1\\GPBMetadata\xea\x02\aApi::V1b\beditionsp\xe8\a"

var file_api_v1_common_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_api_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_api_v1_common_proto_goTypes = []any{
	...
	(*UserProfile)(nil),                     // 14: api.v1.UserProfile
}
var file_api_v1_common_proto_depIdxs = []int32{
	14, // 0: api.v1.GuildMember.profile:type_name -> api.v1.UserProfile
	14, // 1: api.v1.GuildBan.profile:type_name -> api.v1.UserProfile
	14, // 2: api.v1.GuildBan.actor_profile:type_name -> api.v1.UserProfile
