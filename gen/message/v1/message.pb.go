...
type CreateAttachmentUploadRequest struct {
	...
	xxx_hidden_IdempotencyKey *string                `protobuf:"bytes,6,opt,name=idempotency_key,json=idempotencyKey"`
	XXX_raceDetectHookData    protoimpl.RaceDetectHookData
	XXX_presence              [1]uint32
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
...
func (x *CreateMessageResponse) HasAuthor() bool {
	if x == nil {
		return false
	}
...
func (x *CreateMessageResponse) ClearAuthor() {
...
func (x *UpdateMessageResponse) HasAuthor() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Author != nil
...
func (x *UpdateMessageResponse) ClearAuthor() {
	x.xxx_hidden_Author = nil
}
...
func (x *GetMessageResponse) HasAuthor() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Author != nil
...
func (x *GetMessageResponse) ClearAuthor() {
	x.xxx_hidden_Author = nil
}
...
const file_message_v1_message_proto_rawDesc = "" +
	...
	"\bblurhash\x18\t \x01(\tR\bblurhash\"\xef\x01\n" +
	...
	"\amessage\x18\x01 \x01(\v2\x13.message.v1.MessageR\amessage\x12,\n" +
	"\x06author\x18\x02 \x01(\v2\x14.user.v1.UserProfileR\x06author\"\xb9\x01\n" +
	...
	"\achannel\x18\x01 \x01(\v2\x15.message.v1.DmChannelR\achannel\"^\n" +
	"\x15ListDmChannelsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x05R\x05limit\"l\n" +
	"\x16ListDmChannelsResponse\x121\n" +
	"\bchannels\x18\x01 \x03(\v2\x15.message.v1.DmChannelR\bchannels\x12\x1f\n" +
